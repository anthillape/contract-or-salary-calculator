...
/***/ function(module, exports, __webpack_require__) {
	...
	function main(sources) {
		...
		//
		//
		// const totalEarnedProps$ = Rx.Observable.of({label: 'Total Earned'}).combineLatest( totalEarned$, (label, totalEarned) => {
		//
		// 	const foo = {
		// 		...label,
		// 		initial: totalEarned
		// 	};
		// 	return foo;
		// }).subscribe(onNext => console.log(onNext));
		// const totalEarnedOutput = isolate(Output)( {DOM: sources.DOM, props$: totalEarnedProps$} );
		//
		//
		// const totalEarnedVTree$ = totalEarnedOutput.DOM;

		return {
			DOM: _rx2.default.Observable.just(1).map(function (n) {
				return (0, _dom.div)({ className: _app2.default.app }, ['hello'
				// dayRateVTree,
				// weeksWorkedVTree//,
				// totalEarnedVTree
				]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, ".app__app___1JwFe {\n  padding-right: 10px;\n\tdisplay: flex;\n\tflex-direction: column;\n\twidth: 50%;\n\tmargin-left: 25%;\n\talign-items: flex-end;\n}\n", ""]);

	// exports
	exports.locals = {
		"app": "app__app___1JwFe"
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var mockDOMSource = __webpack_require__(65);
	var h = __webpack_require__(12);
	var hh = __webpack_require__(66)(h);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var SVGAttributeNamespace = __webpack_require__(28);
	var attributeHook = __webpack_require__(29);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Rx = __webpack_require__(5);
	var fromEvent = __webpack_require__(31);
	var VDOM = {
	  h: __webpack_require__(12),
	  diff: __webpack_require__(32),
	  patch: __webpack_require__(38),
	  parse: typeof window !== "undefined" ? __webpack_require__(47) : function () {}
	};
	...
	try {
	  matchesSelector = __webpack_require__(51);
	} catch (err) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var isWidget = __webpack_require__(16)
	var isThunk = __webpack_require__(17)
	var handleThunk = __webpack_require__(35)
...
/***/ function(module, exports, __webpack_require__) {
	...
	var propertyMap = __webpack_require__(48);
	var namespaceMap = __webpack_require__(49);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Rx = __webpack_require__(5);
	var toHTML = __webpack_require__(53);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var attrHook = __webpack_require__(29);
	var paramCase = __webpack_require__(56);
	var createAttribute = __webpack_require__(62);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var sentenceCase = __webpack_require__(57)
...
/***/ function(module, exports, __webpack_require__) {
	...
	var lowerCase = __webpack_require__(58)

	var NON_WORD_REGEXP = __webpack_require__(59)
	var CAMEL_CASE_REGEXP = __webpack_require__(60)
	var TRAILING_DIGIT_REGEXP = __webpack_require__(61)
...
/***/ function(module, exports, __webpack_require__) {
	...
	var escape = __webpack_require__(54);
	var propConfig = __webpack_require__(63);
